...
java::lang::Class jvmti::find_loaded_class(const char* class_name)
{
...
std::string jvmti::get_class_signature(const java::lang::Class& klass)
{
...
java::lang::ClassLoader jvmti::get_class_ClassLoader(const java::lang::Class& klass)
{
